...
//     version 1.13.0
//     from Assets/Scripts/InputSystem/Global/GlobalInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/InputSystem/Global/GlobalInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @GlobalInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""9441a95a-66db-4436-9238-8f663e57387f"",
                    ""path"": ""<Mouse>/leftButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""bf1b80de-a5a5-4e9b-b2ca-94073aff05dd"",
    ...
    ~@GlobalInput()
    {
        ...
        UnityEngine.Debug.Assert(!m_InGame.enabled, "This will cause a leak and performance issues, GlobalInput.InGame.Disable() has not been called.");
    }
